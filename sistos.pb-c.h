...
/* Generated from: sistos.proto */

#ifndef PROTOBUF_C_sistos_2eproto__INCLUDED
#define PROTOBUF_C_sistos_2eproto__INCLUDED
...
typedef struct Chat__UserRegistration Chat__UserRegistration;
typedef struct Chat__UserInfo Chat__UserInfo;
typedef struct Chat__UserRequest Chat__UserRequest;
typedef struct Chat__ConnectedUsersResponse Chat__ConnectedUsersResponse;
typedef struct Chat__ChangeStatus Chat__ChangeStatus;
typedef struct Chat__MessageCommunication Chat__MessageCommunication;
typedef struct Chat__ClientPetition Chat__ClientPetition;
typedef struct Chat__ServerResponse Chat__ServerResponse;
 ...
 */
struct  Chat__ConnectedUsersResponse
{
  ProtobufCMessage base;
 ...
 */
struct  Chat__MessageCommunication
{
  ProtobufCMessage base;
  char *message;
  char *recipient;
...
#endif  /* PROTOBUF_C_sistos_2eproto__INCLUDED */
